   ...
   <div class="flex flex-col-reverse md:grid md:grid-cols-12 gap-4 ">
    ...
    <Box>
        ...
        <div class="text-center">
          <h3 class="text-base font-semibold leading-6 text-gray-900">Product Price</h3>
      </div>
        <div class="text-center">
        ...
        <div class="text-center">
          <h3 class="text-base font-semibold leading-6 text-gray-900">Amount</h3>
        </div>
      </div>
    </Box>
...
const price = ref(Array.from({ length: 2 }, () => 0))
const quantity = ref(Array.from({ length: 2}, () => 0))
